    ...
    <section ref={targetRef}>
      <div className="relative h-[800vh]">
        <div className="sticky top-1/2 flex origin-center -translate-y-1/2 justify-center">
          ...
          >
            <video
              ...
              className="h-auto max-h-none w-[70vw] rounded-xl h-auto w-full"
              autoPlay
              loop
              muted
            />
            ...
            >
              <BranchIcon className="mr-3 inline-block h-12 w-12" /> Feature branch
            </motion.span>
          </motion.div>
          <motion.div
            className="translate-x-centered-offset absolute left-1/2 top-1/2 flex w-[50vw] -translate-y-1/2 scale-[var(--scale)] flex-col items-center justify-center"
          ...
          >
            ...
            <motion.span
              ...
              style={{ opacity: newBranchOpacity }}
            >
              <BranchIcon className="mr-3 inline-block h-12 w-12" /> Frontend FYI's branch
            </motion.span>
          </motion.div>
        ...
        >
          ...
          <br />
          <span className="text-primary">Get everybody on the same page. Literally.</span>
        </motion.p>
      </div>
    </section>
  )
